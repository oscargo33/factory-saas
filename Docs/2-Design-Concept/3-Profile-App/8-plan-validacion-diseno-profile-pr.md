...
| PR-VAL-05 | Orders/Support faltantes | Dashboard parcial sin error |
| PR-VAL-06 | Aislamiento tenant | No lectura de datos de otro schema |

---

## 3. Evidencia minima para Sprint Review

- Matriz PR-R01..PR-R07 validada.
...
- [ ] Casos PR-VAL-01..PR-VAL-06 con evidencia.
