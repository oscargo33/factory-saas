...
| 10 | `10-product-visible-admin-po.md` | PO-10-PV | Producto visible + CRUD admin por modelo |
| 11 | `11-roles-permisos-capas-po.md` | PO-11-RBAC | Roles, permisos y capas de interfaz |
